...
const formatCount = count => {
  if (count) {
    ...
    const newCount = Math.round(count * 10000) / 10000; //hack to keep floats with Math.round
...
export const renderRecipe = (recipe, isLiked) => {
  ...
  <div class="recipe__directions">
      ...
      <div class="btn-small recipe__btn" onclick="window.open('${recipe._url}')" >
      <input class="btn-small recipe__btn" value="directions" / >
